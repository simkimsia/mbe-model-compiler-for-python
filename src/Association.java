...
//   TBD-For now, this version also does not support n-ary associations: just binary
//
...
//   assumes all risk of use.
	...
	//Static (class) methods
		...
		// guarantees
		//   returns a populated instance of association (or null, if nothing/error in model file)
		...
		// description
		//   a meta-model operation that tries to find an association named the same as anAssociationName
		// requires
		//   none
		// guarantees
		//   (a reference to) the association with the same name as anAssociationName has been returned
	...
	//Constructor(s)
		...
		//   default constructor
		// requires
		//   anAssociationName is unique among all associations between the participating classes
		// guarantees
	...
	//Accessors
		...
		// description
		//   a meta-model operation that tells whether this association is binary and reflexive
		// requires
		//   none
		// guarantees
	...
	//Modifiers
		...
		// description
		//   a meta-model operation that adds another class as being a participant in this Association
		// requires
		...
		// description
		//   a meta-model operation that removes an (presumably) existing participation from this association
		// requires
		//   none
		// guarantees
...
//  Everything from here down is specific to the model compiler itself
		...
		// description
		//   This rule emits the instance variable declaration for an association that some class participates in
		...
		//   Context.class() <> null
		// guarantees
		//   the instance variable definition has been emitted, considering multiplicity to the other participating class
		...
		// description
		//   This rule emits  instance variable declarations for a binary reflexive association that some class participates in
		//
		...
		// description
		//   This rule emits  instance variable declarations for a binary non-reflexive association that some class participates in
		//
		...
		// description
		//   This rule emits  instance variable initialization for an association that some class participates in
		//     this is embedded into the constructor, right after the contract and going-in assertions
		...
		// description
		//   This rule emits the invariants check for an association that some class participates in
		//   TBD: ONLY HANDLES BINARY ASSOCIATIONS FOR NOW!!!
		//
		...
		// description
		//   This rule emits the invariants check for a binary non-reflexive association that some class participates in
		//
		...
		// description
		//   This rule emits the reference check for an association that some class participates in
		//
		...
		// description
		//   This rule emits the reference check for a binary reflexive association that some class participates in
		//
		...
		// description
		//   This rule emits the reference check for a binary non-reflexive association that some class participates in
		//
		...
		// description
		//   This rule emits the reference check operation for an association that some class participates in
		//
		...
		// description
		//   This rule emits the link & unlink services for an association that some class participates in
		//   TBD: ONLY HANDLES BINARY ASSOCIATIONS FOR NOW!!!
		//
		...
		//   the link & unlink services have been emitted
			Context.setAssociation( this );
			JavaOutput.indent();
			JavaOutput.println( "// link and unlink services for: " + name );
			JavaOutput.println( "" );
		...
		// description
		//   This rule emits link & unlink services for a binary reflexive association that some class participates in
		//
		...
		// description
		//   This rule emits link & unlink services for a binary non-reflexive association that some class participates in
		//
