...
//   assumes all risk of use.
	...
	// Constants
		...
		//	private enum RangeType { SPAN, ENUMERATION, REFERENCE, DERIVED, UNCONSTRIAINED }; -- for full implementation later!	
		private enum RangeType { SPAN, REFERENCE, DERIVED };
	...
	// Static (class) methods
		...
		// requires
		//   Input model stream is open and ready to read at the first line after "<range>"
		// guarantees
		//   returns a populated instance of range (or null, if nothing/error in model file)
		...
		// description
		//   a meta-model operation that tries to find a range named the same as aRangeName
		// requires
	...
	// Accessors
		...
		// description
		//   a meta-model operation that returns whether this is a Reference subtype of Range
		// requires
		//   none
		// guarantees
		...
		// description
		//   a meta-model operation that returns whether this is a Derived subtype of Range
		// requires
		//   none
		// guarantees
		...
		// description
		//   a meta-model operation that returns the referenced spec for a Reference subtype of range
		// requires
		//   none
		// guarantees
		//   returns referencedSpecification only when this is a Reference subtype of Range
		...
		// description
		//   a meta-model operation that returns the derivation policy for a Derived subtype of range
		// requires
		//   none
		// guarantees
		...
		// description
		//   a PIM Overlay operation that returns the declared run time type for this range
		// requires
		//   none
		// guarantees
		...
		// description
		//   a PIM Overlay operation that returns the declared initial value for this range
		// requires
		//   none
		// guarantees
		//   returns declared run time type
		...
		// description
		//   a PIM Overlay operation that returns the derivation policy for a Derived subtype of range
		// requires
		//   none
		// guarantees
		//   returns derivationPolicy only when this is a Derived subtype of Range
	...
	// Modifiers
		...
		// description
		//   a PIM Overlay operation that overwrites the PIM Overlay RT-type with the specified type
		// requires
		...
		// description
		//   a PIM Overlay operation that overwrites the PIM Overlay RT-type initial value with the specified value
		// requires
		...
		// description
		//   a PIM Overlay operation that sets the derivation action code for a Derived subtype of range
		// requires
		//   none
		// guarantees
...
//  Everything from here down is specific to the model compiler itself
		...
		//   the instance variable declaration code for this attribute has been emitted
			JavaOutput.indent();
			JavaOutput.print( "DUMMY DUMMY--not implemented yet" );
		}
