...
| Define with data type but see example code below when data type is the Class itself ✅ | ✅                                                           | ✅                                          | ✅                                                                                       |
...
| Writable *inside* the class in *any instance* method  ✅                                                                                                   | `self._instance_attribute = <new_value>`             | `self.instance_attribute = <new_value>`     | `cls.ClassAttribute = <new_value>`                                                     |
...
| Define with data type but note Python version when data type is the Class itself (see code [here](#define-class-attribute-with-the-class-as-data-type)) ✅ | ✅                                                    | ✅                                           | ✅                                                                                      |
